  ...
  if (
    ...
    || !validation.passwordIsConfirmed(req.body.password, req.body['confirm-password'])
      ...
      sessionFlash.flashDataToSession(req, 
        {
        errorMessage: 
        'Please check your input. Corresponding password and email fields must match. Passwords must be 6 characters long, zip code 5 characters long, and emails must be valid.',
        ...enteredData,
      }, 
      function () {
        res.redirect('/signup');
